        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-zinc-400 mb-6">
              ...
              web development and a growing edge in mobile app creation. I
              specialize in building fast, responsive, and cleanly designed
              applications that deliver real value. Whether it’s a complex web
              platform or a mobile-first experience, I bring ideas to life with
              efficient code and thoughtful design.
            </p>
            <p className="text-zinc-400 mb-6">
              My journey in tech began with a curiosity for how websites work,
              and it’s grown into a deep commitment to crafting high-quality
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-zinc-900/30 border border-zinc-800/50 rounded-lg p-6 hover:border-zinc-700/70 transition-all duration-300">
                ...
                <p className="text-zinc-400 text-sm">
                  Specialized in React Native, React.js, Next.js, and modern
              ...
              <div className="bg-zinc-900/30 border border-zinc-800/50 rounded-lg p-6 hover:border-zinc-700/70 transition-all duration-300">
                ...
                <p className="text-zinc-400 text-sm">
                  Detail-oriented with a focus on creating responsive,
            ...
            <div className="relative pl-8 ml-4">
              ...
              >
                ...
                <div className="bg-gradient-to-br from-zinc-900/40 to-zinc-800/20 backdrop-blur-sm border border-zinc-800/50 rounded-lg p-6 hover:border-zinc-700/70 transition-all duration-300 group">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                    ...
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-500/20 text-purple-400 border border-purple-500/30 mt-2 md:mt-0">
                      <svg
                  ...
                  <div className="flex items-start mb-3 ml-10">
                    ...
                    <p className="text-zinc-400 text-sm">
                      Ganaur, Haryana (Affiliated to Guru Gobind Singh
                  ...
                  <div className="ml-10 bg-zinc-900/50 rounded-md p-3 border-l-2 border-blue-500/50 group-hover:border-blue-500 transition-colors duration-300">
                    <p className="text-zinc-300 text-sm">
                      Completed Bachelor's degree with focus on full-stack
                      development, modern web technologies, and software
                      engineering.
                    </p>
                  </div>
              ...
              >
                ...
                <div className="bg-gradient-to-br from-zinc-900/40 to-zinc-800/20 backdrop-blur-sm border border-zinc-800/50 rounded-lg p-6 hover:border-zinc-700/70 transition-all duration-300 group">
                  ...
                  <h5 className="text-blue-400 font-medium mb-3 ml-10">
                  ...
                  <div className="flex items-start mb-3 ml-10">
                    <MapPin className="w-4 h-4 text-zinc-500 mr-1 mt-0.5 flex-shrink-0" />
                    <p className="text-zinc-400 text-sm">
                      Dwarka Sector-12, New Delhi (CBSE Board)
                    </p>
                  </div>
