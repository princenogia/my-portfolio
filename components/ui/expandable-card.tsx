            ...
            <>
              ...
              >
                <motion.div
                  ...
                  ref={cardRef}
                  className={cn(
                    "relative flex w-full max-w-[850px] flex-col overflow-y-auto bg-zinc-900 shadow-2xl rounded-3xl border border-zinc-700/50 max-h-[90vh] p-6",
                    classNameExpanded,
                  )}
                  {...props}
                >
                  <motion.div layoutId={`image-${title}-${id}`}>
                    <div className="relative">
                      <motion.button
                        ...
                        className="absolute top-4 right-4 z-20 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-zinc-700 bg-black/20 backdrop-blur-md text-white transition-colors duration-300 hover:bg-zinc-800 focus:outline-none"
